...
- Реализуйте методы `save, get, delete, clear, getAll, size` в классе `main.java.com.urise.storage.memory.ArrayStorage`,
...
- Проверьте вашу реализацию с помощью классов `main.java.com.urise.TestMain.MainArray.main()`
  и `main.java.com.urise.TestMain.MainTestArrayStorage.main()`
...
1. Не меняйте сигнатуры методов в `main.java.com.urise.storage.memory.ArrayStorage`
